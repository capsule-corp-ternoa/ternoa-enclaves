...
subxt metadata --url wss://mainnet.ternoa.io:443 > ternoa_mainnet.scale 2>/dev/null
# subxt metadata --url wss://betanet.ternoa.network:443 > ternoa_betanet.scale 2>/dev/null
