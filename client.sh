...
curl --cacert ./credentials/certificates/ssl_certs/141-94-162-96/ca_bundle.crt -X POST https://141.94.162.196:3000/api/nft/storeSecretShares -H 'Content-Type: application/json' -d '{"account_address":"5ChoJxKns4yyHeZg38U2hc8WYQ691oHzPJZtnayZXFyXvXET","secret_data":{"nft_id": 48384, "data": [84, 104, 105, 115, 32, 105, 115, 32, 97, 32, 115, 104, 97, 114, 101, 32, 111, 102, 32, 53, 32, 115, 104, 97, 114, 101, 115, 33]}, "signature": "b470dd2191c15df731e7fd38b416bc4024f8203702b5218fb8b30cd5fc8e1d0493651435e19339dddcef8e4c247d7a92f831405d8acb435405a11170b7360380"}'
