...
use subxt::ext::sp_core::{sr25519, ByteArray, Pair};
...
pub async fn store_secret_shares(
    ...
    match verified_secret {
        Ok(secret) => {
            ...
            println!("Secret is successfully stored to TEE, nft_id = {} by Owner = {}", secret.nft_id, received_secret.account_address);
...
pub async fn retrieve_secret_shares(
    ...
    match verified_req {
        Ok(data) => {
            ...
            println!("Secret shares of {} retrieved by {}",data.nft_id, requested_secret.account_address);
